...
* **PPU** - scanline/dot renderer with per-scanline sprite evaluation (8-sprite
  ...
  `$2007` read buffer.
* **APU** - two pulse channels, triangle, noise and DMC, with the hardware output filter
...
* Window scaling 1x to 6x, aspect modes (pixel-perfect / 4:3 / stretch), fullscreen
  with `Alt+Enter`.
